...
export default class Engineered extends SawnLumber{
    constructor({size, noPly, species, Lu, Lx, Ly, method, duration,moisture,temperature,spacing,bearing,incision,flat,L=21}){
		super({ size, species, noPly, method, Lu, Lx, Ly, duration, moisture, temperature, spacing, bearing, incision, flat})
		this.L = L*12
        //this.size = find(WoodEngineeredSize.List, {'size': size})
        // this.b = this.size.b 
        // this.d = this.size.d
        this.b = size.b 
        this.d = size.d
        this.noPly = noPly
		this.name = size.type
        // this.species = find(WoodEngineeredSpecies.List, {'species': species})
        ...
        this.Fvy = species.Fv
		this.Fc = species.Fc
		this.Fcp = species.Fcp
		this.E = species.E
        this.Emin = species.Emin
		this.G = species.SG
        this.c = 0.9
    }//CONSTRUCTOR
