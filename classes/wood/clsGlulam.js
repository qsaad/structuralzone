...
export default class Glulam extends SawnLumber{
    constructor({size, noPly,species, Lu, Lx, Ly, method, duration,moisture,temperature,bearing,incision,flat,radius=0,L=21,category="Western",grade="Softwood"}){
		super({ size, noPly, species, method, Lu, Lx, Ly, duration, moisture, temperature, bearing, incision, flat})
		this.L = L*12
        this.grade = grade
        this.category = category
        //this.sizeList = this.category == "Western" ? WoodGlulamWesternSize.List : WoodGlulamSouthernSize.List
        //this.size = find(this.sizeList, {'size': size})
        // this.b = this.size.b 
        // this.d = this.size.d
        this.b = size.b 
        this.d = size.d
        ...
        // this.species = find(this.speciesList, {'species': species})
        ...
        // this.speciesList = this.grade == "Softwood" ? WoodGlulamSpecies.List :  WoodGlulamHardwoodSpecies.List
        // this.species = find(this.speciesList, {'species': species})
        this.Fbx = species.Fbx_bot
        this.Fby = species.Fby
        this.Ft = species.Ft
        this.Fvx = species.Fvx
        this.Fvy = species.Fvy
		this.Fc = species.Fc
		this.Fcp = species.Fcpx
        this.E = species.Ex
        this.Ex = species.Ex
        this.Ey = species.Ey
        this.Emin = species.Ex_min
        this.Ex_min = species.Ex_min
        this.Ey_min = species.Ey_min
		this.G = species.G
        this.c = 0.9
		this.tapered = false
		this.radius = radius
		this.t = this.category == "Western" ? 1.5 : 1.375
    }//CONSTRUCTOR
