...
import * as WoodSawnSize from '@/data/WoodSawnSize'
...
export default class SawnLumber extends Wood {
    constructor({size,noPly = 1, species,Lu = 12,Lx = 12, Ly = 12, method="ASD",duration="DL",moisture="Dry",temperature="<100",spacing=30,bearing=1.5,incision=false,flat=false}){
		super({ method, duration, moisture, temperature})
		//this.method = method
		//this.size = find(WoodSawnSize.List, {'size': size})
		this.noPly = noPly
		// this.b = this.size.b 
		// this.d = this.size.d
        this.b = size.b 
